#!/usr/bin/env python3
"""
סורק את תיקיית דוחות Northrop Grumman ומעדכן את public/data/northrop.json
נתונים מספריים מ-public/data/northrop-metrics.json אם קיים.
"""
import json
import re
...
REPORTS = ROOT.parent / "Northrop Grumman"
OUT = ROOT / "public" / "data" / "northrop.json"
METRICS_PATH = ROOT / "public" / "data" / "northrop-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מיליוני דולר ארה״ב (MUSD); המקור בדוחות המאוחדים בדולרים במיליונים.",
