#!/usr/bin/env python3
"""
סורק את תיקיית דוחות רפאל ומעדכן את public/data/rafael.json
נתונים מספריים מ-public/data/rafael-metrics.json אם קיים.
"""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
REPORTS = ROOT.parent / "רפאל"
OUT = ROOT / "public" / "data" / "rafael.json"
METRICS_PATH = ROOT / "public" / "data" / "rafael-metrics.json"

YEAR_RE = __import__("re").compile(r"(?<![0-9])(202[0-5])(?![0-9])")
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מקור דיווח בשקלים; באתר מומר ל־MUSD לפי שער ממוצע שנתי (בנק ישראל) — ראה rafael-metrics insights.",
