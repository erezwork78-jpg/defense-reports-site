#!/usr/bin/env python3
"""
סורק את תיקיית דוחות L3Harris (כולל PDF ו-HTM של SEC) ומעדכן את public/data/l3harris.json
נתונים מספריים מ-public/data/l3harris-metrics.json אם קיים.
"""
import json
import re
...
REPORTS = ROOT.parent / "L3Harris"
OUT = ROOT / "public" / "data" / "l3harris.json"
METRICS_PATH = ROOT / "public" / "data" / "l3harris-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מיליוני דולר ארה״ב (MUSD); L3Harris מדווחת לפי שנת כספים (מועד סגירה בסביבות תחילת ינואר) — בדוחות המקור.",
