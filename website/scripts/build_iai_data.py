#!/usr/bin/env python3
"""
סורק את תיקיית דוחות IAI ומעדכן את public/data/iai.json
(רשימת קבצים + שנים מהשם). נתונים מספריים נשמרים מ-public/data/iai-metrics.json אם קיים.
"""
import json
import os
import re
...
REPORTS = ROOT.parent / "01. IAI"
OUT = ROOT / "public" / "data" / "iai.json"
METRICS_PATH = ROOT / "public" / "data" / "iai-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מיליוני דולר ארה״ב (MUSD) אם לא צוין אחרת; ערכים null עד שממלאים מהדוחות.",
