#!/usr/bin/env python3
"""סורק את תיקיית BAE Systems ומעדכן את public/data/bae.json"""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
REPORTS = ROOT.parent / "BAE Systems"
OUT = ROOT / "public" / "data" / "bae.json"
METRICS_PATH = ROOT / "public" / "data" / "bae-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מקור בלירה שטרלינג; באתר MUSD עם המרה אינדיקטיבית — ראה bae-metrics insights.",
