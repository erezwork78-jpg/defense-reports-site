#!/usr/bin/env python3
"""סורק את תיקיית Thales ומעדכן את public/data/thales.json"""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
REPORTS = ROOT.parent / "Thales"
OUT = ROOT / "public" / "data" / "thales.json"
METRICS_PATH = ROOT / "public" / "data" / "thales-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מקור ביורו (IFRS); באתר MUSD עם המרה אינדיקטיבית — ראה thales-metrics insights.",
