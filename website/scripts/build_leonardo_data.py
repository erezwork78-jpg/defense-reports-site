#!/usr/bin/env python3
"""סורק את תיקיית Leonardo Spa ומעדכן את public/data/leonardo.json"""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
REPORTS = ROOT.parent / "Leonardo Spa"
OUT = ROOT / "public" / "data" / "leonardo.json"
METRICS_PATH = ROOT / "public" / "data" / "leonardo-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מקור ביורו (IFRS); באתר MUSD עם המרה אינדיקטיבית — ראה leonardo-metrics insights.",
