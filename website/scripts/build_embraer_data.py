#!/usr/bin/env python3
"""סורק את תיקיית EMBRAER ומעדכן את public/data/embraer.json"""
import json
import re
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
REPORTS = ROOT.parent / "EMBRAER"
OUT = ROOT / "public" / "data" / "embraer.json"
METRICS_PATH = ROOT / "public" / "data" / "embraer-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מיליוני דולר ארה״ב (MUSD) לפי דוחות ו־20-F.",
