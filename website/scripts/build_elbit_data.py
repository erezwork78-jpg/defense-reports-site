#!/usr/bin/env python3
"""
סורק את תיקיית דוחות אלביט ומעדכן את public/data/elbit.json
נתונים מספריים מ-public/data/elbit-metrics.json אם קיים.
"""
import json
import os
import re
...
REPORTS = ROOT.parent / "אלביט"
OUT = ROOT / "public" / "data" / "elbit.json"
METRICS_PATH = ROOT / "public" / "data" / "elbit-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "מיליוני דולר ארה״ב (MUSD); המקור בדוחות באלפי דולרים.",
