#!/usr/bin/env python3
"""
סורק את תיקיית דוחות RTX ומעדכן את public/data/rtx.json
נתונים מספריים מ-public/data/rtx-metrics.json אם קיים.
"""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
REPORTS = ROOT.parent / "RTX"
OUT = ROOT / "public" / "data" / "rtx.json"
METRICS_PATH = ROOT / "public" / "data" / "rtx-metrics.json"
...
def main() -> None:
    ...
    payload = {
        ...
        "currencyNote": "דיווח בדולר ארה״ב (USD); באתר מוצגים מיליוני דולר (MUSD) — ראה rtx-metrics insights.",
